...
monster_strength = random.choice(list(monster_power.keys()))
power_strength = monster_power[monster_strength]
print(f"The monster rolled: {monster_power} (strength: {power_strength})")

#update monsters combat strength
#increase the monster's combat strength (dont let it exceed 6)
m_combat_strength = random.randint(1, 6)
m_combat_strength = min(6, m_combat_strength + power_strength)

print(f"The monster's updated combat strength is {m_combat_strength} using {monster_power}")

#Define an empty array called belt
belt = []
...
loot_item_1 = random.choice(loot_options)
loot_options.remove(loot_item_1)
belt.append(loot_item_1)
print(f"Added {loot_item_1} to your belt. current belt: {belt}")

#collecting the second loot item
input("Press Enter to roll for your second loot item...")
loot_item_2 = random.choice(loot_options)
loot_options.remove(loot_item_2)
belt.append(loot_item_2)
print(f"Added {loot_item_2} to your belt. current belt: {belt}")

#alphabetical organization
print("\nOrganizing the belt alphabetically...")
belt.sort()
print(f"The organized belt: {belt}")

#using the first loot item
input("\nA monster appears! you can use your first loot item in your belt. Press Enter to use it...")
used_loot = belt.pop(0)
print(f"You used {used_loot}")

#check the type of loot used
health_points = min(6, health_points + 2) if used_loot in good_loot_options else \
                max(0, health_points - 2) if used_loot in bad_loot_options else health_points

print(f"Updated health points after using {used_loot} : {health_points}")
